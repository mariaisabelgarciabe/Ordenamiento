...
public class DocumentosServicio {
    ...
    public static void cargar(String nombreArchivo) {
        try {
            ...
            documentos = lineas
                    ...
                    .map(partes -> new Documento(partes[0], partes[1], partes[2], partes[3]))
    ...
    private static boolean esMayor(Documento d1, Documento d2, int criterio) {
        if (criterio == 0) { // primero por el Nombre Completo y luego por el Tipo de Documento
        ...
        // primero por el Tipo de Documento y luego por el Nombre Completo
